...
#result_df['EARLIEST_OVERALL_DATE'] = result_df[['FIRST_AD_CDR_DATE', 'FIRST_AD_FLOWSHEET_DATE', 'FIRST_AD_DIAGNOSIS_DATE', 'FIRST_AD_MED_DATE']].min(axis=1) # take out CDR, and ICD from this
result_df['EARLIEST_OVERALL_DATE'] = result_df[['FIRST_AD_FLOWSHEET_DATE', 'FIRST_AD_MED_DATE']].min(axis=1)
...
# Merge the dataframes on 'EPIC_MRN'
merged_df = pd.merge(labs, ad_demo_phecode[['EPIC_MRN', 'INDEX_DATE']], on='EPIC_MRN', how='left')

# Filter the rows where LAB_RSLT_COLLECTION_DTTM is before INDEX_DATE
filtered_labs = merged_df[merged_df['LAB_RSLT_COLLECTION_DTTM'] < merged_df['INDEX_DATE']]
...
positive_pet_mrns = pd.read_csv('/storage1/fs1/aditigupta/Active/Will/ML_LLM_AD/AD_prediction/LLM_extract/rapid_progression/positive_pet_mrns.csv')['EPIC_MRN']
...
################################## Notes #######################################################################
###############################################################################################################################
note_ids = pd.read_csv('/storage1/fs1/aditigupta/Active/Will/ML_LLM_AD/AD_prediction/LLM_extract/llama_modeling/clinical_note_ids.csv')
                  
df1 = pd.read_csv('/storage1/fs1/aditigupta/Active/Will/ML_LLM_AD/AD_prediction/LLM_extract/llama_modeling/results_llama3.2-120k_htn_dept_atr_infarct.csv')
df2 = pd.read_csv('/storage1/fs1/aditigupta/Active/Will/ML_LLM_AD/AD_prediction/LLM_extract/llama_modeling/results_llama3.2-120k_htn_dept_atr_infarct2.csv')
df3 = pd.read_csv('/storage1/fs1/aditigupta/Active/Will/ML_LLM_AD/AD_prediction/LLM_extract/llama_modeling/results_llama3.2-120k_htn_dept_atr_infarct3.csv')
df4 = pd.read_csv('/storage1/fs1/aditigupta/Active/Will/ML_LLM_AD/AD_prediction/LLM_extract/llama_modeling/results_llama3.2-120k_htn_dept_atr_infarct4.csv')
...
df1 = pd.read_csv('/storage1/fs1/aditigupta/Active/Will/ML_LLM_AD/AD_prediction/LLM_extract/llama_modeling/results_llama3.2-120k_llama_repeat_misplace_famhx.csv')
df2 = pd.read_csv('/storage1/fs1/aditigupta/Active/Will/ML_LLM_AD/AD_prediction/LLM_extract/llama_modeling/results_llama3.2-120k_llama_repeat_misplace_famhx2.csv')
df3 = pd.read_csv('/storage1/fs1/aditigupta/Active/Will/ML_LLM_AD/AD_prediction/LLM_extract/llama_modeling/results_llama3.2-120k_llama_repeat_misplace_famhx3.csv')
...
################################## Saving to CSV #######################################################################
############################################################################################################################### 
ad_demo_phecode.to_csv("/storage1/fs1/aditigupta/Active/Will/ML_LLM_AD/AD_prediction/df_extract_ad_prediction_clean.csv", index=False)
