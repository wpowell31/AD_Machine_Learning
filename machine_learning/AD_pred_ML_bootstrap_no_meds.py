...
X = df.drop(columns=['EPIC_MRN', 'FIRST_ENC', 'LAST_ENC', 'DIFF_YEARS', 'INDEX_TIME_ENC',
       ...
       'PT_ZIPCODE', 'Memory loss', 'Dementias', 'Mild cognitive impairment', 'Central Nervous System (CNS) conditions', 'Dementia with cerebral degenerations', 'Vascular dementia'])
y = df['AD_label']
...
for model_name in models:
    ...
    with open(f'/storage1/fs1/aditigupta/Active/Will/ML_LLM_AD/AD_prediction/{model_name.lower()}_model_metrics_bootstrap_no_meds.txt', 'a') as f:
    ...
    plt.savefig(f'/storage1/fs1/aditigupta/Active/Will/ML_LLM_AD/AD_prediction/{model_name.lower()}_shap_summary_plot_bootstrap_no_meds.png', bbox_inches='tight')
    plt.close()
