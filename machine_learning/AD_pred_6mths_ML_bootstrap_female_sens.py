...
for model_name in models:
    ...
    with open(f'/storage1/fs1/aditigupta/Active/Will/ML_LLM_AD/AD_prediction/6months/{model_name.lower()}_model_metrics_bootstrap_female_sens.txt', 'a') as f:
    ...
    plt.savefig(f'/storage1/fs1/aditigupta/Active/Will/ML_LLM_AD/AD_prediction/6months/{model_name.lower()}_shap_summary_plot_bootstrap_female_sens.png', bbox_inches='tight')
    plt.close()
